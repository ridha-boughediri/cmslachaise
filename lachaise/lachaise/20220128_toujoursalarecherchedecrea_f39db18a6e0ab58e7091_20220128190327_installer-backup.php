...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220128_toujoursalarecherchedecrea_f39db18a6e0ab58e7091_20220128190327_archive.zip';
	const ARCHIVE_SIZE		 = '120386582';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f39db18-28190327';
    const SECONDARY_PACKAGE_HASH = '396d5ab-28190327';
	const VERSION			 = '1.4.3';
